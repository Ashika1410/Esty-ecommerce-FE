...
// import { GardenData } from "../Data/DetailPageData";
...
export default function Garden({ gardenProducts }) {
  return (
    <>
      <Navbar />
      <div className="bg-white">
        ...
        <div className="mx-auto max-w-7xl px-8 py-16">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {gardenProducts.length > 0 ? (
              gardenProducts.map((product) => <ProductCard key={product.productID} product={product} />)
            ) : (
